...
describe("Anonymous Row-Level Security Boundary", () => {
  ...
  it("denies anonymous access to private player alerts", async () => {
    const anonClient = createClient(supabaseUrl, supabaseAnonKey, {
      auth: { persistSession: false, autoRefreshToken: false },
    });
  ...
  it("denies anonymous access to private player holdings", async () => {
    const anonClient = createClient(supabaseUrl, supabaseAnonKey, {
      auth: { persistSession: false, autoRefreshToken: false },
    });
  ...
  it("denies anonymous access to private player points", async () => {
    const anonClient = createClient(supabaseUrl, supabaseAnonKey, {
      auth: { persistSession: false, autoRefreshToken: false },
    });
